...
print(X_vec_cat)
'''
#训练 GaussianNB/BernoulliNB
import time
t1=time.time()
from sklearn.naive_bayes import GaussianNB
gnb = GaussianNB()
gnb.fit(X_vec_con[:30000,:],data.iloc[:30000]['状态'])
#iloc是将序列当作数组来访问，下标会从0开始
t2=time.time()
print(t2-t1)
#保存训练模型,joblib.load可恢复
#from sklearn.externals import joblib
#joblib.dump(gnb, "D:/python/model/GaussianNB.pkl")
predictLabels=gnb.predict(X_vec_con[30000:,:])
t3=time.time()
print(t3-t2)
print(predictLabels)
...
a=data[30000:]
print(sum(a[a['状态']=='1']['pre']=='1'))
print(sum(a[a['状态']=='0']['pre']=='1'))
print(sum(a[a['状态']=='1']['pre']=='0'))
print(sum(a[a['状态']=='0']['pre']=='0'))
